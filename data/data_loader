...
class Dataset_Pred(Dataset):
    def __init__(self, root_path, flag='pred', size=None, 
                 features='S', data_path='ETTh1.csv', 
                 target='OT', scale=True, inverse=False, timeenc=0, freq='15min', cols=None, train_ratio=0.8, dev_ratio=0.1, test_ratio=0.1):
        # size [seq_len, label_len, pred_len]
        # info
        #import ipdb; ipdb.set_trace()
        if size == None:
    ...
    def __read_data__(self):
        ...
        border1 = len(df_raw)-self.seq_len    # border1 = 124416-1152 = 123264
        border2 = len(df_raw)                 # border2 = 124416
