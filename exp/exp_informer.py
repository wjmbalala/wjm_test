...
class Exp_Informer(Exp_Basic):
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            #import ipdb; ipdb.set_trace()
            # TODO 加载预训练模型
            # model_path = r'C:\Users\wjm\Desktop\informer-main-0324\checkpoints\informer_ETTh2ms1f2_ftms_sl1152_ll1152_pl576_dm512_nh8_el3_dl2_df2048_atprob_fc5_ebtimeF_dtTrue_mxTrue_exp_0\checkpoint.pth'
